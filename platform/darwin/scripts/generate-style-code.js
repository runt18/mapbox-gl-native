...
for (let layer of layers) {
    ...
    _.assign(renamedProperties, _.filter(layer.layoutProperties, property => 'original' in property));
    _.assign(renamedProperties, _.filter(layer.paintProperties, property => 'original' in property));
